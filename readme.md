...
This repository is based on a [blog post]( https://waylonwalker.com/blog/realistic-git-workflow/) that I created.  We will work through some examples in the workshop and see how far we get.
